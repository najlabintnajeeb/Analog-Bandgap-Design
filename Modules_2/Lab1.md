...
4. Variable Supply Simulation

File: ```ngspice ./bgr_lvt_rpolyh_3p40_var_supply.sp```
...
•	Vref remains stable across supply voltage variation
•	Startup circuit triggers correctly, reaching steady-state in ~1.1 µs
